...
This particular power supply can be used with up to three pedals.  However the 600w PSU might be a bit overkill for one or two pedals; consider using the [350w Power Supply](https://github.com/chrisjameschamp/DIY-Active-Pedal-Design/tree/main/Design%20Files/350w%20Power%20Supply) instead.
...
|---------------------------------|-----------------|---------|----------|
| MEANWELL LRS-600-36             | LRS-600-36      | 1       | [Link](https://www.omc-stepperonline.com/lrs-600-36-mean-well-597-6w-36vdc-16-6a-115-230vac-enclosed-switching-power-supply-lrs-600-36) |
...
2. **PCIe Extension Cables** – The 600w PSU enclosure uses **3** PCIe extension cables. Additional pedal-side PCIe cables are counted separately.
